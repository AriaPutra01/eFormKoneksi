...
<body class="font-sans antialiased">
    <div style="background-image: url({{ asset('build/image/bjbBG.jpg') }})" class="bg-left-top">
        <div style="background-image: linear-gradient(to right, rgb(0, 0, 50), rgba(0, 0, 0, 0));" class="p-5">
            <nav x-data="{ isOpen: false }" class="bg-white rounded-md">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-center space-x-4">
                                    <a href="{{ route('/') }}"
                                        class="px-3 py-2 text-sm font-medium text-gray-800 border-b-2 border-blue-500"
                                        aria-current="page">Dashboard</a>
                                    <a href="{{ route('pemohonKoneksi.create') }}"
                                        class="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:text-blue-500 transition-all">Form
                                        koneksi</a>
                ...
                <div x-show=isOpen class="md:hidden transi" id="mobile-menu">
                    <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                        <a href="{{ route('/') }}"
                            class="block rounded-md bg-white px-3 py-2 text-base font-medium text-blue-500"
                            aria-current="page">Dashboard</a>
                        <a href="{{ route('pemohonKoneksi.create') }}"
                            class="block rounded-md px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-400 hover:text-white">Form
                            koneksi</a>
                        <a href="{{ route('pemohonEmail.create') }}"
                            class="block rounded-md px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-400 hover:text-white">Form
                            e-mail</a>
            ...
            <div class="relative isolate px-6 lg:px-8 my-10">
                <div class="mx-auto">
                    <div class="md:w-1/2">
    ...
    <main>
        <h1 class="mx-10 mt-4 p-2 border-b-2 border-blue-950 text-lg font-bold">e-Form</h1>
        <div class="flex flex-wrap justify-center">
            <div class="w-full md:w-1/2 p-8">
                <a href="{{ route('pemohonKoneksi.create') }}"
                    class="block h-full bg-gray-100 hover:bg-white hover:-translate-y-3 hover:shadow-2xl transition-all rounded-md shadow-xl p-4">
                    <h5 class="text-lg font-bold mb-2 text-gray-800 p-1 w-fit">Form Koneksi
                    </h5>
                    <p class="text-gray-500">Form permohonan untuk pengajuan pembukaan koneksi.
                    </p>
                </a>
            </div>
            <div class="w-full md:w-1/2 p-8">
                <a href="{{ route('pemohonEmail.create') }}"
                    class="block h-full bg-gray-100 hover:bg-white hover:-translate-y-3 hover:shadow-2xl transition-all rounded-md shadow-xl p-4">
                    <h5 class="text-lg font-bold mb-2 text-gray-800 p-1 w-fit">Form Email
                    </h5>
                    <p class="text-gray-500">Form permohonan untuk pendaftaran, pengaktifan dan
                        penghapusan
                        e-mail perusahaan.</p>
                </a>
            </div>
